...
module.exports = {
    ...
    // * show a phone - by client id and array index of the emails
    async show (req, res) {
        try {
            ...
            itemGet.emails[req.params.index-array] = req.body;
    ...
    async store (req, res) {
        try {
            ...
            for(var i = 0;i< requestBody.length;i++) {
                ...
                itemGet.emails.push(requestBody[i]);
            }
            const item = await Client.update(itemGet);
            return res.json(item);
